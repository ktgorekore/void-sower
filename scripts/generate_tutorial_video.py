...
NARRATION_TEXT = (
    ...
    "Maneuver horizontally along the command arc to evade incoming ordnance. "
    "Your primary weapon is the ancient sixteen-bay Bao Mancala capacitor ring. "
    "Tap any bay to load a plasma core, then swipe left or right to sow energy seeds sequentially around the orbital ring. "
    "When your sow terminates in frontline batteries eight through fifteen, it unleashes a catastrophic upward Particle Lance. "
